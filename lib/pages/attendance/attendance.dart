          ...
          _isLoading
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      _AttendanceRow(employee: attendanceList[index]),
                ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Expanded(flex: 2, child: Text(employee['full_name'] ?? "Unknown")),
      ...
      content: Column(
        ...
        children: [
          if (employee['image_url'] != null)
            Image.network(employee['image_url'], height: 200),
          const SizedBox(height: 10),
