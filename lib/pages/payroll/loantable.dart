      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Row(
              children: [
                const CircleAvatar(radius: 18, backgroundColor: Color(0xFFEEEEEE), child: Icon(Icons.person, size: 20, color: Colors.grey)),
                const SizedBox(width: 12),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(name, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
                    Text(role, style: const TextStyle(color: Colors.black45, fontSize: 11)),
                  ],
                ),
              ],
            ),
          ),
          Expanded(flex: 2, child: Text(loan, style: const TextStyle(fontWeight: FontWeight.w600))),
          Expanded(flex: 2, child: Text(salary, style: const TextStyle(fontWeight: FontWeight.w500))),
          Expanded(flex: 1, child: Text(deduction, style: const TextStyle(color: Colors.black54))),
          Expanded(flex: 2, child: Text(balance, style: TextStyle(fontWeight: FontWeight.w700, color: balance == "\$0.00" ? Colors.black26 : const Color(0xFF0C5D6B)))),
          ...
          Expanded(
            ...
            child: UnconstrainedBox(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Icon(isActive ? Icons.circle : Icons.check_circle, size: 8, color: isActive ? const Color(0xFF00A389) : Colors.black45),
                    const SizedBox(width: 6),
                    Text(status, style: TextStyle(color: isActive ? const Color(0xFF00A389) : Colors.black54, fontSize: 11, fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
            ),
          ...
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(
                color: action == "Archive" ? Colors.black26 : const Color(0xFF0C5D6B),
                fontSize: 12,
